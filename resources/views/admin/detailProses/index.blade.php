                ...
                <tr>
                  ...
                  <td>
                    ...
                    <div class="dropdown">
                      ...
                      @elseif($masterbarangs[$value2->id_barang]["namaBarang"]=="Raw" and $value2->jumlahBarang>0 and ($value2->status==2 or $value2->status==3 or $value2->status==8))
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <div class="dropdown">
                          ...
                          @elseif($value3->status==2 or $value3->status==3 or $value3->Status==8))
